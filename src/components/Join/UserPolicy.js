  ...
  return (
    <Container>
      ...
      <div className='term 5'>
        ...
        <ol>
          <li>정보주체는 오늘의 데이트에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</li>
          <li>제1항에 따른 권리 행사는 오늘의 데이트에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 오늘의 데이트은(는) 이에 대해 지체 없이 조치하겠습니다.</li>
      ...
      <div className='term 7'>
        ...
        <ul className='ul_square'>
          <li>오늘의 데이트 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.</li>
        </ul>
      </div>
