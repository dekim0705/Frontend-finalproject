...
const ChatRoom = () => {
  ...
  const intialMessage = (menuNumber) => {
    switch (menuNumber) {
      ...
      case 2:
        return <> 멤버십 가입자분들은 광고 없는 피드를 이용할 수 있습니다. 광고의 방해 없이 오늘의 데이트를 자유롭게 즐겨보세요! <br/> <br /> ✅ 실제 결제는 이루어지지 않습니다. </>;
      case 3:
        return (
      ...
      case 4:
        return (
          <>게시물/댓글에 대한 신고 절차를 안내해드리겠습니다. <br/>만약 부적절한 게시물이나 댓글을 발견하셨다면, 해당 항목의 오른쪽 상단에 있는 점 세 개를 클릭해주세요! <br/> 그런 다음, 신고하기 메뉴를 선택해주세요. 🚨  <br/>선택하신 게시물 또는 댓글은 신고가 접수되어 처리됩니다.  <br/> <br/>더 안전하고 쾌적한 커뮤니티 환경을 위해 여러분의 적극적인 참여를 부탁드립니다! </> 
        );
      case 5:
        return (
